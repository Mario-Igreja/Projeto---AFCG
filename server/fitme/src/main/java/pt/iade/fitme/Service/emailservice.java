...
@Service
public class EmailService implements pt.iade.fitme.webserver.services.Service {
    ...
    public ConfirmKeyResponse sendMail(MailDetail mailDetail) {
        ...
        String msgBody = "Para confirmar o seu email, introduza, na app Fitme, o seguinte código:\t";
